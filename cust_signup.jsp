    ...
    <body>
        <div class="site-logo">
            ...
            <!-----start-main---->
                ...
                <center>
                    <form method="POST" action="CustSignupServlet">
                    ...
                    <input required type="text" name="mobile" placeholder="Mobile number" maxlength="10"><br><br>
                    <br>
                    <input type="submit" value="Signup" class="loginbtn loginbtn1">
                    
                    <div class ="forgot">
                        <h3><a style="text-decoration: none" href="cust_login.jsp">Already have an account?<br>Login</a></h3>
                    </div>
                    </fieldset>
                        <br>
